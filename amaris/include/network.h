...
namespace amaris
{
	...
	AMARIS_API std::string ComStateToString(const COM_STATE state);
	...
	class AMARIS_API SocketEvent : public Event
	{
	public:
		enum Type : int
		{
	...
	class AMARIS_API Socket : public Publisher, public Listener
	{
	public:
	...
	class AMARIS_API SocketPrototype : public Publisher
	{
	public:
